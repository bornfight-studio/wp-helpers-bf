...
abstract class BFImagePluginProvider {
	protected function get_image_by_custom_size( int $image_id, array $sizes ): string {
	...
	protected function get_image_by_size_name( int $image_id, string $size_name ): string {
	...
	protected function get_attachment_url( int $attachment_id ): string {
